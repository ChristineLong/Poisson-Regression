...
+ Intercept b0: Since the length of fish cannot be 0, nor can the area be 0, the intercept has no actual meaning.
+ Coefficient of Year (b1): Given length of fish and area fixed, every 1 year increase would increase the log odds rate of the number of parasite by -9.710e-02.
+ Coefficient of Length (b2): Given year and area fixed, every 1 unit increase in the length of fish would increase the log odds rate of the number of parasite by -2.972e-02.
+ Coefficient of Area (b3): Given year and length of fish fixed, every 1 unit change in area would increase the log odds rate of the number of parasite by 6.201e-01.
...
####Question 3
```{r}
m2.fit = zeroinfl(Intensity ~ Year + Area | Length, data = para_data)
summary(m2.fit)
```

Intepretation:

+ Intercept b0: Since the the area can't be 0, the intercept has no actual meaning.
+ Coefficient of Year (b1): Given length of fish and area fixed, every 1 year increase would increase the log odds rate of the number of parasite by -0.11226.
+ Coefficient of Area (b2): Given year and length of fish fixed, every 1 unit change in area would increase the log odds rate of the number of parasite by 0.44329.

+ Coefficient of Length: Given year and area fixed, for 1 unit increase in the length of fish, the log odds ration of susceptible to parasites over not susceptible to parasites would be -0.002162.
